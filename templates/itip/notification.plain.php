<?php echo $this->subject ?> (<?php printf(_("on %s at %s"), $this->event->start->format('short', new \Horde\Date\Formatter\IcuFormatter(), $GLOBALS['language']), (new \IntlDateFormatter($GLOBALS['language'], \IntlDateFormatter::NONE, \IntlDateFormatter::MEDIUM))->format($this->event->start->timestamp())) ?>)
